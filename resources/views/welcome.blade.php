...
<body>
    ...
    <footer id="contact" class="home-contact"><div class="container home-contact-inner"><img src="{{ asset('data/WhatsApp Image 2026-08-23 at 3.36.55 PM.jpeg') }}" alt="Tech College crest"><h2>Tech College of Skills Development & Placement</h2><p><i data-lucide="phone"></i> 051-4627600</p><p><i data-lucide="mail"></i> info@techcollege.com.pk</p></div><div class="copyright">&copy; {{ date('Y') }} Tech College of Skills Development & Placement. All Rights Reserved.</div></footer>
